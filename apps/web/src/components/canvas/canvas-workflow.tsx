					...
					<DialogHeader>
						...
						<DialogDescription>
							{workflow.preview?.request.resumeOf
								...
								: "Each listed step generates a new result using saved prompts and settings. Shared inputs run once. Selected historical inputs are reused."}
						</DialogDescription>
					</DialogHeader>
					<p className="text-muted-foreground text-xs">
											...
											{step.imageInput === "history"
												...
												: step.imageInput === "project"
													...
													: workflow.preview?.request.resumeOf
														...
														: "Uses the new image generated by this workflow."}
										</span>
									) : null}
								</span>
